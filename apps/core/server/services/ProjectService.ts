...
export class ProjectService {
  ...
  async createProject(data: ProjectCreateData): Promise<Project> {
    try {
      ...
      logger.info(
        { projectId: project.id, ownerId: data.ownerId },
        "Created project",
      );
      return project;
    } catch (error) {
      logger.error(
        { err: error },
        "[ProjectService] Failed to create project:",
      );
      throw error;
    }
  }
  ...
  async getUserProjects(
    ...
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to get user projects:",
      );
      throw error;
    }
  }
  ...
  async getAllProjects(includeArchived: boolean = false): Promise<Project[]> {
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to get all projects:",
      );
      throw error;
    }
  }
  ...
  async updateProject(
    ...
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to update project:",
      );
      throw error;
    }
  }
  ...
  async archiveProject(id: string): Promise<Project> {
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to archive project:",
      );
      throw error;
    }
  }
  ...
  async restoreProject(id: string): Promise<Project> {
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to restore project:",
      );
      throw error;
    }
  }
  ...
  async deleteProject(id: string): Promise<void> {
    try {
      ...
      logger.info({ projectId: id }, "Deleted project");
    } catch (error) {
      logger.error(
        { err: error },
        "[ProjectService] Failed to delete project:",
      );
      throw error;
    }
  }
  ...
  async getProjectAssets(
    ...
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to get project assets:",
      );
      throw error;
    }
  }
  ...
  async getProjectStats(projectId: string): Promise<{
    ...
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to get project stats:",
      );
      throw error;
    }
  }
  ...
  async getPublicProjects(userId: string): Promise<Project[]> {
    try {
      ...
      logger.error(
        { err: error },
        "[ProjectService] Failed to get public projects:",
      );
      throw error;
    }
  }
