  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (result.data) {
        ...
        const questWithMeta = {
          ...result.data.quest,
          questType: result.data.quest.questType || "custom",
          difficulty: result.data.quest.difficulty || "medium",
          metadata: {},
        } as QuestData & {
          id: string;
          difficulty: string;
        ...
        setLastGeneratedQuest(questWithMeta);
        onGenerated?.(questWithMeta, result.data.rawResponse);
