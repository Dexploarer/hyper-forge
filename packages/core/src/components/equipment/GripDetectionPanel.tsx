        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-text-secondary mt-0.5">
              Automatically detect weapon grip point
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-3 p-3 bg-bg-secondary/40 rounded-lg border border-white/10">
              ...
              <div className="text-xs space-y-1">
                ...
                <div className="font-mono text-text-primary">
                  ({handleDetectionResult.gripPoint.x.toFixed(3)},{" "}
                  {handleDetectionResult.gripPoint.y.toFixed(3)},{" "}
                  {handleDetectionResult.gripPoint.z.toFixed(3)})
                </div>
              </div>
