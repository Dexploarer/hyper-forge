        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <CardDescription className="text-xs mt-0.5">
              Select materials for your asset
            </CardDescription>
          </div>
        </div>
      </CardHeader>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-tooltip">
      ...
      {selectedMaterials.map((matId) => {
        ...
        return (
          <div key={matId} className="space-y-1">
            ...
            <Textarea
              value={
                materialPromptOverrides[matId] || preset?.stylePrompt || ""
              }
