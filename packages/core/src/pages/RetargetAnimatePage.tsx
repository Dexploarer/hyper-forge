...
export const RetargetAnimatePage: React.FC = () => {
  ...
  const handleConvertToVRM = async () => {
    ...
    try {
      ...
      console.log("[RetargetAnimatePage] GLB loaded successfully");
            ...
            <aside className="border border-border-primary bg-bg-secondary p-4 flex flex-col gap-4 rounded-xl">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs text-text-tertiary mt-1">
                          Opens the VRM Test Viewer with Idle, Walk, Run, and
                          Jump animations. Click the toggle in the top-right to
                ...
                <section className="space-y-3 p-3 border border-border-primary rounded-md">
                  ...
                  {vrmConverted && (
                    <div className="p-2 bg-green-500/10 border border-green-500/30 rounded-md mb-2">
                      <p className="text-xs text-green-400">
                        ✨ Testing VRM animations! Character should stand
                        upright with correct orientation.
                      </p>
                    </div>
                  )}
                  ...
                  {availableAnimations.length === 0 ? (
                    ...
                    <div className="space-y-2">
                      <div className="space-y-1">
                        <label className="text-xs text-text-tertiary">
                          Select Animation ({availableAnimations.length}{" "}
                          available)
                        </label>
                        <select
                          className="w-full px-2 py-1 rounded-md bg-bg-tertiary text-sm"
                  ...
                  <p className="text-xs text-text-tertiary">
                    ...
                    dropdown to access all {availableAnimations.length}{" "}
                    animations.
                  </p>
                </section>
              )}
              ...
              {retargetingApplied && (
                <section className="space-y-3 p-3 border border-border-primary rounded-md">
                  ...
                  <p className="text-xs text-text-tertiary">
                    Export the retargeted model as a GLB file with the new
                    skeleton.
                  </p>
                </section>
              )}
