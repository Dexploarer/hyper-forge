    ...
    <div className="h-full overflow-y-auto p-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Left Panel - Asset Selection - Full width mobile, 3 cols desktop */}
          ...
          {/* Center - 3D Viewport - Full width mobile, 6 cols desktop */}
          ...
          {/* Right Panel - Controls - Full width mobile, 3 cols desktop */}
          <div className="lg:col-span-3">
            <div className="card overflow-hidden flex flex-col">
        {/* Header */}
        <div className="p-3 border-b border-border-primary">
          <h3 className="text-base font-semibold text-text-primary">Fitting Controls</h3>
        </div>
