...
test.describe("Security and Access Control", () => {
  ...
  test("should maintain session across page reloads", async ({ page }) => {
    ...
    const isAuth1 = await auth.checkAuthentication();
    ...
    const isAuth2 = await auth.checkAuthentication();
  ...
  test("should logout successfully", async ({ page }) => {
    ...
    const isAuthBefore = await auth.checkAuthentication();
    ...
    const isAuthAfter = await auth.checkAuthentication();
