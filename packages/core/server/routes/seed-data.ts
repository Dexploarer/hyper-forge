...
export const createSeedDataRoutes = () => {
  const seedDataService = new SeedDataService();
  const relationshipService = new RelationshipService();

  return new Elysia({ prefix: "/api/seed-data", name: "seed-data" })
    ...
    .post(
      ...
      async ({ body }) => {
        ...
        console.log(
          `[SeedData] Generating ${scale} ${genre} world: ${theme}`,
        );
        ...
        console.log(
          `[SeedData] Created ${locationMap.size} locations`,
        );
        ...
        console.log(
          `[SeedData] Created all relationships from seed data`,
        );
