/**
 * Caching Plugin for Elysia 2025
 *
 ...
 * ```
 *
 * For route-level ETag support:
 * ```ts
 * import { generateETag, isNotModified } from '../plugins/caching.plugin';
 *
 ...
 */
export const cachingPlugin = new Elysia({ name: "caching" })
